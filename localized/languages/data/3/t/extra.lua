...
m["tkn"] = {
	aliases = {"Toku-no-Shima", "Tokunoshima"},
}
...
m["tnk"] = {
	aliases = {"Nafe", "South Tanna"},
	varieties = {"Port Resolution", "Imaki"},
}
...
m["tnp"] = {
	aliases = {"East Tanna", "Narak"},
	varieties = {"Waesisi", "Lometimeti"},
}

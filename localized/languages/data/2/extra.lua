...
m["ak"] = {
	varieties = {"Twi-Fante", "Twi", {"Fante", "Fanti"}, "Asante", "Akuapem", "Abron", "Brong", "Wasa"},
}
...
m["cy"] = {
	varieties = {"Cofi Welsh", {"Dyfedeg", "Dyfed Welsh", "Demetian"}, {"Gwenhwyseg", "Gwent Welsh", "Gwentian"}, {"Gwyndodeg", "Gwynedd Welsh", "Venedotian"}, {"Powyseg", "Powys Welsh", "Powysian"}, "Patagonian Welsh"},
}
...
m["rm"] = {
	aliases = {"Romansch", "Rumantsch", "Romanche"},
	-- don't list varieties here that are in [[Module:etymology languages/data]]
	varieties = {"Sursilvan-Oberland"}, -- extra variety in Glottolog; main varieties have their own etym codes
}

...
m["rsk"] = {
	...
	standardChars = "АаБбВвГгҐґДдЕеЄєЖжЗзИиІіЇїЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЬьЮюЯя" .. c.punc:gsub("'", ""),  -- Exclude apostrophe.
}


m["rsm"] = {
	"Bahasa Isyarat Miriwoong",
	24090240,
	"sgn",
}

...
-- Sedang ditukar kepada keluarga "Min Nan" ("zhx-nan", yang akan mengambil kod "nan" apabila bahasa itu dapat dikeluarkan). Kekalkan nama "Min Nan" di sini untuk mengelakkan keperluan memindahkan perkara yang sememangnya dijadualkan untuk pelupusan.
m["nan"] = {
"Min Nan",
36495,
"zhx-com",
...
"Yale",
2992915,
"qfa-dis", -- Papua; pencilan dalam Glottolog dan Palmer (2018); di bawah cadangan keluarga Sungai Senu dalam Usher (2020)
"Latn",
}
...
-- nkv dilayan sebagai nkt, lihat [[WT:LT]]
...
-- "nom" Nocamán digabungkan oleh ISO ke dalam "cbr"
...
m["nrp"] = {
	"Picene Utara",
	430138,
	"qfa-unc", -- pupus, mungkin satu penipuan
	"Ital",
	-- translit Ital dalam [[Module:scripts/data]]
}
...
-- ISO menggabungkan "nte" ke dalam "eko"
...
m["nwc"] = {
	...
	"sit-new",
	"Brah, Deva, Newa, Ranj",
	-- Translit Brah dalam [[Module:scripts/data]] (NOTA: tidak hadir sebelum ini, berkemungkinan ketinggalan secara tidak sengaja)
}
...
35761,
"afa",
"Tfng, Latn", --Tfng mungkin tidak menyokong semua aksara yang diperlukan
}
...
-- nxu (Narau) digabungkan ke dalam bpp (Kaure) mengikut penggabungan ISO 639-3 2020
...
"Nyaw",
26425602,
"tai-nor", -- Chamberlain (1991), tetapi Pittayaporn (2009) mencadangkan tai-swe
"Thai, Tayo", -- Thailand
sort_key = "Thai-sortkey", -- tiada kesan pada Latn
}

...
m["gac"] = {
	"Andaman Besar Campuran",
	56329630,
	"qfa-adn",
	"Latn",
}

m["gad"] = { -- jangan dikelirukan dengan gdk, gdg
	"Gaddang",
	3438830,
	"phi",
	"Latn",
...
m["gae"] = {
	"Baniwa Guainia", -- Warekena, bezakan daripada awd-war
	1091095,
	"awd-nwk",
	"Latn",
}
...
m["gag"] = {
	...
	sort_key = {
		Latn = {
			from = {
				"i", -- Memastikan "i" hadir selepas "ı".
				"ä", "ç", "ê", "ı", "ö", "ş", "ţ", "ü"
			},
			to = {
				"i" .. p[1],
...
m["gdg"] = { -- jangan dikelirukan dengan gad, gdk
	"Ga'dang",
	5515189,
	"phi",
	"Latn",
...
m["gdk"] = { -- jangan dikelirukan dengan gad, gdg
	"Gadang",
	56256,
	"cdc-est",
	"Latn",
...
m["gdm"] = {
	"Laal",
	33436,
	"qfa-dis", -- Chad; tidak terkelas, pencilan atau dikelompokkan dengan bahasa-bahasa Adamawa atau Chadik
	"Latn",
}
...
-- gok ialah bahasa palsu, lihat [[w:Spurious languages]]
...
m["gpn"] = {
	"Taiap",
	56237,
	"qfa-dis", -- Papua; pencilan dalam Glottolog; perkaitan dengan Torricelli dicadangkan oleh Usher
	"Latn",
}
...
m["grx"] = {
	"Guriaso",
	12631954,
	"qfa-unc", -- tiada konsensus; mungkin Kwomtari menurut Baron (1983) dan Usher (2020), tetapi tiada pertalian diterima oleh
			   -- Glottolog.
	"Latn",
}
...
m["gsp"] = {
	"Wasembo",
	7971402,
	"ngf-mad", -- diletakkan di bawah Pesisir Rai oleh Glottolog (di bawah Yaganon Raya) dan Pawley-Hammarström
	"Latn",
}
...
m["gta"] = {
	"Guató",
	3027940,
	"qfa-dis", -- pencilan atau Makro-Jê
	"Latn",
}

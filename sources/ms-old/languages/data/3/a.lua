...
-- "aae" dilayan sebagai "sq", lihat [[WT:LT]]
...
m["aaf"] = {
	...
	"dra-mal",
	"Mlym",
	-- Translit Mlym dalam [[Module:scripts/data]] (NOTA: tidak hadir sebelum ini, berkemungkinan ketinggalan secara tidak sengaja)
}
...
-- "aat" dilayan sebagai "sq", lihat [[WT:LT]]
...
m["abq"] = {
	...
	sort_key = {
		Cyrl = {
			from = {
				"гъв", "гъь", "гӏв", "джв", "джь", "къв", "къь", "кӏв", "кӏь", "хъв", "хӏв", "чӏв", -- 3 aksara
				"гв", "гъ", "гь", "гӏ", "дж", "дз", "ё", "жв", "жь", "кв", "къ", "кь", "кӏ", "ль", "лӏ", "пӏ", "тл", "тш", "тӏ", "фӏ", "хв", "хъ", "хь", "хӏ", "цӏ", "чв", "чӏ", "шв", "шӏ" -- 2 aksara
			},
			to = {
...
-- "abr" Abron dilayan sebagai "ak" Akan, lihat [[WT:LT]]
...
m["ace"] = {
	...
	"Latn, Arab",
	standard_chars = {
		Latn = "AaBbCcDdEeÉéÈèËëFfGgHhIiJjKkLlMmNnOoÔôÖöPpQqRrSsTtUuVvWwXxYyZz", -- ortografi semasa (belum menambah Arab)
		c.punc
	},
}
...
m["ady"] = {
	...
	sort_key = {
		Cyrl = {
			from = {
				"кхъу", "къӏу", -- 4 aksara
				"гъу", "джу", "дзу", "жъу", "къу", "кхъ", "къӏ", "кӏу", "кӏь", "лъу", "лӏу", "пӏу", "сӏу", "тӏу", "фӏу", "хъу", "цӏу", "чъу", "чӏу", "шъу", "шӏу", "щӏу", -- 3 aksara
				"гу", "гъ", "гь", "дж", "дз", "ё", "жъ", "жь", "ку", "къ", "кь", "кӏ", "лъ", "ль", "лӏ", "пӏ", "сӏ", "тӏ", "фӏ", "ху", "хъ", "хь", "цу", "цӏ", "чу", "чъ", "чӏ", "шъ", "шӏ", "щӏ", "ӏу", "ӏь" -- 2 aksara
			},
			to = {
				"к" .. p[5], "к" .. p[7],
...
-- m["ajt"] Arab Yahudi-Tunisia kini disertakan dalam Arab Tunisia

-- m["aju"] Arab Yahudi-Maghribi kini disertakan dalam Arab Maghribi
...
m["akc"] = {
	"Mpur",
	3327139,
	"qfa-iso", -- Papua; berdasarkan Palmer (2018), Ethnologue dan Glottolog
	"Latn",
}
...
-- "aln" dilayan sebagai "sq", lihat [[WT:LT]]
...
m["anz"] = {
	"Anem",
	56512,
	"qfa-dis", -- Papua; mungkin bahasa pencilan atau dalam keluarga andaian New Britain Barat
	"Latn",
}
...
m["aob"] = {
	"Abom",
	3446647,
	"qfa-dis", -- Papua; berkemungkinan bahasa Tirio mencapah (keluarga Anim), atau nod TNG peringkat teratas
	"Latn",
}
...
m["aog"] = {
	"Angoram",
	56366, -- rujuk 6754745 bagi dialek gabungan
	"paa-lse",
	"Latn",
}
...
m["aqc"] = {
	...
	sort_key = {
		from = {
			"ккъӏв", "ххьӏв", -- 5 aksara
			"гъӏв", "ёоӏ", "ккъӏ", "ккъв", "къӏв", "ллъв", "ххьӏ", "хъӏв", "хьӏв", "ццӏв", "ччӏв", -- 4 aksara
			"ааӏ", "гӏв", "гъӏ", "гъв", "гьв", "ееӏ", "ёӏ", "ёо", "ииӏ", "кӏв", "ккв", "ккъ", "къӏ", "къв", "кьв", "лӏв", "ллъ", "лъв", "льв", "ооӏ", "пӏв", "ппв", "ссв", "тӏв", "ттв", "ууӏ", "хӏв", "ххв", "хъӏ", "хъв", "хьӏ", "цӏв", "ццӏ", "ццв", "чӏв", "ччӏ", "ээӏ", "юуӏ", "яаӏ", -- 3 aksara
			"аӏ", "аа", "гӏ", "гв", "гъ", "гь", "дв", "еӏ", "ее", "ё", "жв", "зв", "иӏ", "ии", "кӏ", "кв", "кк", "къ", "кь", "лӏ", "лв", "лъ", "ль", "оӏ", "оо", "пӏ", "пв", "пп", "св", "сс", "тӏ", "тв", "тт", "уӏ", "уу", "фв", "хӏ", "хв", "хх", "хъ", "цӏ", "цв", "цц", "чӏ", "чв", "шв", "щв", "эӏ", "ээ", "юӏ", "юу", "яӏ", "яа" -- 2 aksara
		},
		to = {
			"к" .. p[8], "х" .. p[7],
...
m["arc"] = {
	...
	strip_diacritics = {
		-- Tiga yang pertama ditambah oleh [[User:Wikitiki89]] pada tahun 2015 untuk digunakan dengan Suryani, yang mempunyai tanda diakritik menyerupai
		-- diaeresis (syāmē) dan makron di atas dan di bawah (mṭalqānā); lihat Wikipedia [[w:Syriac alphabet]]. Namun
		-- saya tidak tahu sama ada ia benar-benar diwakili menggunakan tanda-tanda diakritik ini.
		Syrc = {remove_diacritics = c.macron .. c.diaer .. c.macronbelow .. u(0x0730) .. "-" .. u(0x0748)},
	},
	-- display_text, strip_diacritics, sort_key Hebr dalam [[Module:scripts/data]]
	-- strip_diacritics, sort_key Samr dalam [[Module:scripts/data]]; sebelum ini tiada sort_key bagi Samr, berkemungkinan satu kesilapan
	-- Translit Phnx dalam [[Module:scripts/data]] (NOTA: tidak hadir sebelum ini, berkemungkinan ketinggalan secara tidak sengaja)
}
...
m["ash"] = {
	"Abishira",
	2871740,
	"qfa-dis", -- pupus, kurang didokumentasikan; pencilan atau dalam cadangan keluarga Tequiraca-Canichana oleh Kaufman (1994)
	"Latn",
}
...
m["ata"] = {
	"Pele-Ata",
	56511,
	"qfa-dis", -- Papua; berkemungkinan dalam keluarga andaian New Britain Barat, atau pencilan
	"Latn",
}
...
m["atb"] = {
	...
	"tbq-brm",
	"Latn, Lisu", -- juga Hani?
	-- Translit, sort_key Lisu dalam [[Module:scripts/data]]
}
...
-- avo Agavotaguerra telah dibersarakan
...
-- ayy dipadam dan dialih keluar daripada ISO; menurut permohonan pembuangan, "tiada data linguistik wujud untuk mana-mana bahasa [Ayta] yang
-- mungkin pernah dituturkan oleh nenek moyang kumpulan ini. Oleh itu, tiada bukti bahawa kumpulan ini pernah mempunyai bahasa
-- yang berbeza daripada mana-mana bahasa Filipina yang lain." [Lobel]

m["ayz"] = {
	"Maybrat",
	4830892,
	"paa-may",
	-- sama ada bahasa pencilan; dikelompokkan dengan Abun dan keluarga Kepala Burung Barat; atau dalam keluarga andaian Papua Barat
	"Latn",
}

...
m["mag"] = {
	"Magahi", -- Jangan dikelirukan dengan Prakrit Magadhi (pra-mag)
	33728,
	"inc-bih",
	"Deva, Kthi",
	translit = {
...
m["mbo"] = { -- seperti 'bqz', 'bsi' dan 'bss', merupakan dialek Manenguba
	"Mbo (Cameroon)",
	36011,
	"bnt-mne",
	"Latn",
...
-- mcv (Minanibai) digabungkan ke dalam ffi (Foia Foia) mengikut Glottolog
...
m["mgk"] = {
	"Mawes",
	6794395,
	"qfa-dis", -- Papua; pencilan dalam Glottolog, Foley (2018) dan Hammarström (2010); dalam bahasa-bahasa Tor-Kwerba per
			   -- Usher (2020)
	"Latn",
}
...
-- mjg "Monguor" tidak diiktiraf sebagai bahasa, tetapi merupakan kod keluarga
...
m["mka"] = {
	"Mbre",
	3450154,
	"nic", --tidak terkelas dalam niger-congo
}
...
m["mnc"] = {
	...
	"mnc-Mong, Latn",
	ancestors = "juc",
	-- translit mnc-Mong dalam [[Module:scripts/data]]
}
...
m["moq"] = {
	"Mor (Papua)",
	11732468,
	"qfa-dis", -- Papua; pencilan dalam Glottolog dan Palmer (2018); nod TNG peringkat teratas dalam Ross (2005), dalam Teluk Berau (di bawah
			   -- TNG) dalam Usher (2020)
}
...
m["mrf"] = {
	"Elseng",
	3915667,
	"qfa-unc", -- "Bahasa sempadan atau pencilan"; tidak dapat dikelaskan kerana kekurangan data
	"Latn",
}
...
m["mtr"] = {
	...
	"raj",
	"Deva",
	translit = "hi-translit", -- buat sementara waktu
}
...
m["mtv"] = {
	"Asaro'o",
	3503684,
	"ngf-war", -- ngf-moa jika kita mengasingkan Molet daripada Asaro'o
	"Latn",
}
...
m["mul"] = {
	...
	"qfa-not",
	"All",
	-- NOTA: Kunci isih berikut digunakan dalam process_page() dalam [[Module:headword/page]], yang menjana
	-- kunci isih lalai untuk halaman (sepadan dengan {{DEFAULTSORT:...}}) dengan menjana kunci isih untuk
	-- nama halaman menggunakan `makeSortKey()` yang dipanggil pada objek bahasa "mul". Pada masa ini ini hanya mengendalikan
	-- kunci isih Jepun.
	--
	-- AMARAN: Ini sepatutnya lebih bijak dan menggunakan bahasa halaman jika hanya ada satu.
	sort_key = {
		Hani = "Hani-sortkey",
		Jpan = "Jpan-sortkey",
		Hrkt = "Hira-sortkey", -- Isih semua kana sebagai Hira.
		Hira = "Hira-sortkey",
		Kana = "Hira-sortkey",
	},
...
m["mvs"] = {
	"Massep",
	3502895,
	"qfa-dis", -- kurang didokumentasikan (tetapi dalam kegunaan aktif); pencilan mengikut Ethnologue, Glottolog, dan Foley (2018); Kwerba
			   -- Raya menurut Usher
	"Latn",
}
...
m["mwr"] = {
	...
	"Deva, Mahj, Aran",
	translit = {
		Deva = "hi-translit", -- buat sementara waktu
		Mahj = "Mahj-translit",
	},
}

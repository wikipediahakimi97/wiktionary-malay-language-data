...
m["enm"] = {
	...
	sort_key = {
		...
		to = {
			{
				["ꟓ"] = "þþ", ["ꟕ"] = "ƿƿ", -- dimuktamadkan oleh penggantian seterusnya
			},
			{
...
m["err"] = {
	"Erre",
	10488401,
	"qfa-iso", -- Evans (1997) meletakkannya dalam keluarga Tanah Arnhem
	"Latn",
}
...
-- "esi" dan "esk" dipindahkan kepada khusus etimologi mengikut [[WT:LT]] dan [[Wiktionary:Beer_parlour/2023/August#Issues_regarding_the_Inuit_languages]]

m["esl"] = {
	"Bahasa Isyarat Mesir",
	5348443,
	"sgn",
}
...
m["esq"] = {
	"Esselen",
	1294243,
	"qfa-dis", -- pencilan atau Hokan
	"Latn",
}

m["ess"] = {
	"Yupik Siberia Tengah",
	27993,
	"ypk",
	"Cyrl, Latn",
}
...
m["esy"] = {
	...
	867086,
	"art",
	"Latn", -- juga skrip aslinya tersendiri
}

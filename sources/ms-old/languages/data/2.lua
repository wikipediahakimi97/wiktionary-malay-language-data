...
m["ab"] = {
	...
	translit = {
		Cyrl = "ab-translit",
		-- translit Geor dalam [[Module:scripts/data]]
	},
	...
	sort_key = {
		Cyrl = {
			from = {
				"х'ә", -- 3 aksara
				"гь", "гә", "ӷь", "ҕь", "ӷә", "ҕә", "дә", "ё", "жь", "жә", "ҙә", "ӡә", "ӡ'", "кь", "кә", "қь", "қә", "ҟь", "ҟә", "ҫә", "тә", "ҭә", "ф'", "хь", "хә", "х'", "ҳә", "ць", "цә", "ц'", "ҵә", "ҵ'", "шь", "шә", "џь", -- 2 aksara
				"ӷ", "ҕ", "ҙ", "ӡ", "қ", "ҟ", "ԥ", "ҧ", "ҫ", "ҭ", "ҳ", "ҵ", "ҷ", "ҽ", "ҿ", "ҩ", "џ", "ә", -- 1 aksara
				"^а",
			},
			to = {
				"х" .. p[4],
...
m["be"] = {
	...
	standard_chars = {
		...
		(c.punc:gsub("'", "")) -- Kecualikan koma atas.
	},
}
...
m["el"] = {
	...
	override_translit = true,
	-- display_text, strip_diacritics, sort_key Grek dan Polyt dalam [[Module:scripts/data]]
	standard_chars = {
...
m["en"] = {
	...
	1860,
	"gmw-ang",
	"Latn, Brai, Shaw, Dsrt", -- entri dalam Shaw atau Dsrt mungkin memerlukan perbincangan terlebih dahulu
	wikimedia_codes = "en, simple",
	ancestors = "en-ear",
	sort_key = {
		Latn = {
			-- Kebanyakannya diperlukan untuk mengisih nama bahasa.
			remove_diacritics = "'\"%-%.,%s·ʻʼ" .. c.diacritics,
			-- Ini ditemui dalam nama halaman.
...
m["fa"] = {
	...
	strip_diacritics = {
		Arab = {
			-- aksara "ۂ" kod U+06C2 kepada "ه" dan "هٔ" (U+0647 + U+0654) kepada "ه"; hamzatu l-waṣli kepada alif biasa
			from = {"هٔ", "ٱ"}, -- aksara "ۂ" kod U+06C2 kepada "ه"; hamzatu l-waṣli kepada alif biasa
			to = {"ه", "ا"},
...
m["fi"] = {
	...
	strip_diacritics = { -- digunakan untuk menunjukkan geminasi konsonan seterusnya
		remove_diacritics = "ˣ",
		from = {"’"},
		to = {"'"},
	},
	sort_key = { -- [[Lampiran:Abjad Finland#Susunan]] + "aͤ" dan "oͤ" sebagai varian bersejarah bagi "ä" dan "ö".
...
m["he"] = {
	...
	ancestors = "he-med",
	-- display_text, strip_diacritics, sort_key Hebr dalam [[Module:scripts/data]]
	-- strip_diacritics, sort_key Samr dalam [[Module:scripts/data]]
...
m["ht"] = {
	...
	sort_key = {
		from = {
			"oun", -- 3 aksara
			"an", "ch", "è", "en", "ng", "ò", "on", "ou", "ui" -- 2 aksara
		},
		to = {
			"o" .. p[4],
...
m["hu"] = {
	...
	sort_key = {
		Latn = {
			from = {
				"dzs", -- 3 aksara
				"á", "cs", "dz", "é", "gy", "í", "ly", "ny", "ó", "ö", "ő", "sz", "ty", "ú", "ü", "ű", "zs", -- 2 aksara
			},
			to = {
				"d" .. p[2],
...
m["hy"] = {
	...
	"Armn, Brai",
	ancestors = "axm",
	-- translit Armn dalam [[Module:scripts/data]]
	override_translit = true,
	strip_diacritics = {
		Armn = {
			remove_diacritics = "՛՜՞՟",
...
m["ik"] = {
	...
	sort_key = {
		from = {
			"ch", "ġ", "dj", "ḷ", "ł̣", "ñ", "ng", "r̂", "sr", "zr", -- 2 aksara
			"ł", "ŋ", "ʼ" -- 1 aksara
		},
		to = {
...
m["jv"] = {
	...
	link_tr = true,
	strip_diacritics = {
		Latn = {remove_diacritics = c.circ} -- jv moden tidak menggunakan ê
	},
	sort_key = {
		Latn = {
...
m["ka"] = {
	...
	8108,
	"ccs-gzn",
	"Geor, Geok, Hebr", -- Hebr digunakan untuk menulis Judeo-Georgia
	ancestors = "ka-mid",
	-- translit Geor, Geok dalam [[Module:scripts/data]]
	override_translit = true,
	strip_diacritics = {
...
m["km"] = {
	...
	"Khmr",
	ancestors = "xhm",
	translit = "km-translit", -- Ini mungkin memberikan hasil yang tidak diingini melainkan entrinya mempunyai {{km-IPA}}.
}
...
m["kr"] = {
	...
	"ssa-sah",
	"Latn, Arab",
	-- sortkey dan strip_diacritics hanya untuk Kanuri piawai; apabila entri dialek ditambah, seseorang perlu memikirkan bagaimana dialek harus diwakili secara ortografi
	strip_diacritics = {
...
-- "kv" dilayan sebagai "koi", "kpv", lihat [[WT:LT]]
...
m["lo"] = {
	...
	9211,
	"tai-swe",
	"Laoo", -- juga tulisan Tai Noi/Lao Buhan
...
m["lv"] = {
	...
	"Latn",
	strip_diacritics = {
		-- Ini cuba menukar vokal bertanda nada kepada vokal sama ada dengan atau tanpa makron. Khususnya, tidak sepatutnya ada makron jika vokal adalah sebahagian daripada diftong (termasuk diftong resonan seperti pìrksts -> pirksts bukan #pīrksts). Apa yang kita lakukan mula-mula adalah menukar vokal + tanda nada kepada vokal + tilde secara terurai, kemudian membuang tilde dalam diftong, seterusnya menukar baki jujukan vokal + tilde kepada vokal bermakron, dan akhirnya memadam sebarang tilde lain. Kita biarkan vokal yang sudah bermakron: Kedua-dua contohnya ar dan ār berlaku sebelum konsonan. BAIKI: Ini mungkin masih tidak mencukupi.
...
m["mk"] = {
	...
	translit = {
		Cyrl = "mk-translit",
		-- BAIKI: dahulunya tiada translit ditentukan untuk Polyt; tidak jelas sama ada lalai
		-- [[Module:grc-translit]] boleh diterima, jadi kita lumpuhkannya buat masa ini
		Polyt = false,
	},
	strip_diacritics = {
		Cyrl = {
	...
	-- display_text, strip_diacritics, sort_key Polyt dalam [[Module:scripts/data]]
	standard_chars = {
...
m["mn"] = {
	...
	translit = {
		Cyrl = "mn-translit",
		-- translit Mong dalam [[Module:scripts/data]]
	},
	override_translit = true,
	-- display_text dan strip_diacritics Mong dalam [[Module:scripts/data]]
	strip_diacritics = {
...
-- "mo" dilayan sebagai "ro", lihat [[WT:LT]]
...
m["mt"] = {
	...
	sort_key = {
		from = {
			"ċ", "ġ", "ż", -- Tukar ke dalam PUA supaya bentuk terurai tidak ditangkap oleh langkah seterusnya.
			"([cgz])", -- Pastikan "c" datang selepas "ċ", "g" datang selepas "ġ" dan "z" datang selepas "ż".
			"g" .. p[1] .. "ħ", -- "għ" selepas penukaran awal "g".
			p[3], p[4], "ħ", "ie", p[5] -- Tukar "ċ", "ġ", "ħ", "ie", "ż" kepada output akhir.
		},
		to = {
			p[3], p[4], p[5],
			"%1" .. p[1],
...
m["nb"] = {
	...
	"Latn",
	wikimedia_codes = "no",
	ancestors = "gmq-mno, da",  -- da sebagai satu (tetapi bukan satu-satunya) leluhur kepada nb telah dipersetujui - jangan tukar tanpa perbincangan
...
m["nv"] = {
	...
	sort_key = {
		...
		from = {
			"chʼ", "tłʼ", "tsʼ", -- 3 aksara
			"ch", "dl", "dz", "gh", "hw", "kʼ", "kw", "sh", "tł", "ts", "zh", -- 2 aksara
			"ł", "ʼ" -- 1 aksara
		},
		to = {
			"c" .. p[2], "t" .. p[2], "t" .. p[4],
...
m["pi"] = {
	...
	36727,
	"inc-mid",
	"Latn, Brah, Deva, Beng, Sinh, Mymr, Thai, Lana, Laoo, Khmr, Cakm", -- dan juga Khom
	ancestors = "sa",
	translit = {
	...
	strip_diacritics = {
		Thai = {
			from = {"ึ", u(0xF700), u(0xF70F)}, -- BAIKI: Tidak jelas apa yang berlaku dengan aksara-aksara PUA di sini.
			to = {"ิํ", "ฐ", "ญ"}
		},
		Mymr = {
	...
	sort_key = { -- BAIKI: Ini perlu ditukar kepada format standard semasa.
...
m["ro"] = {
	...
	-- strip_diacritics, sort_key Cyrs dalam [[Module:scripts/data]]; mungkin tidak hadir
	standard_chars = {
...
m["sa"] = {
	...
	11059,
	"inc",
	"as-Beng, Bali, Beng, Bhks, Brah, Mymr, xwo-Mong, Deva, Gujr, Guru, Gran, Hani, Java, Kthi, Knda, Kawi, Khar, Khmr, Laoo, Mlym, mnc-Mong, Marc, Modi, Mong, Nand, Newa, Orya, Phag, Ranj, Saur, Shrd, Sidd, Sinh, Soyo, Lana, Takr, Taml, Tang, Telu, Thai, Tibt, Tutg, Tirh, Zanb", -- dan juga Khom; kod skrip diisih mengikut nama kanonikal dan bukannya kod untuk [[MOD:sa-convert]]
	translit = {
		...
		-- translit Mong, mnc-Mong, xwo-Mong dalam [[Module:scripts/data]]
		-- NOTA: Dahulunya menggunakan xal-translit untuk mentransliterasi xwo-Mong tetapi itu hanya mengendalikan abjad Cyril; ia mempunyai
		-- kod untuk mentransliterasi xwo-Mong tetapi ia rosak jadi saya telah menggantikannya dengan xwo-translit lalai.
		Mymr = "pi-translit",
		...
		Thai = "pi-translit",
		-- translit Tibt dalam [[Module:scripts/data]]
	},
	-- display_text dan strip_diacritics Mong dalam [[Module:scripts/data]]
	-- display_text, strip_diacritics, sort_key Tibt dalam [[Module:scripts/data]]
	strip_diacritics = {
	...
	sort_key = {
		Deva = s["sa-Deva-stripdiacritics"], -- sehingga kita mempunyai algoritma isihan Sanskrit yang wajar.
		Lana = { -- Tai Tham
		...
		Thai = "Thai-sortkey",
		-- BAIKI: Kekunci isihan sebelumnya yang mencampurkan semua skrip membuang ZWJ; saya tidak tahu skrip mana yang ini
		-- dimaksudkan dan tiada bahasa lain yang membuangnya dalam kekunci isihan setahu saya. Jika ia perlu
		-- dibuang, nyatakan skrip yang ia perlu dibuang di bawahnya atau tambah pengendalian untuk skrip "all" yang terpakai
		-- tanpa mengira skrip.
		--all = {
...
m["sh"] = {
	...
	"zls",
	"Latn, Cyrl, Glag, Arab",
	ietf_subtag = "hbs", -- kod ISO 639-3, memandangkan "sh" telah lapuk daripada ISO 639-1
...
m["sq"] = {
	...
	-- display_text, strip_diacritics, sort_key Grek dalam [[Module:scripts/data]]
	strip_diacritics = {
		Latn = {
	...
	sort_key = {
		...
		-- TODO: Grek jika kekunci isihan lalai tidak sesuai
	},
	standard_chars = {
...
m["tr"] = {
	...
	sort_key = {
		from = {
			-- Abaikan sirkumfleks, tetapi ambil kira Î besar tersilap menjadi ı + circ kerana logik i dengan/tanpa titik.
			"ı" .. c.circ, c.circ,
			"i", -- Pastikan "i" datang selepas "ı".
			"ç", "ğ", "ı", "ö", "ş", "ü"
		},
...
m["tt"] = {
	...
	--override_translit = true, -- dayakan pengesampingan sehingga kod Modul boleh mengesan pinjaman Rusia seperti [[аэропорт]]
	dotted_dotless_i = true,
	sort_key = {
		Cyrl = {
...
-- "tw" dilayan sebagai "ak", lihat [[WT:LT]]
...
m["uk"] = {
	...
	standard_chars = "АаБбВвГгДдЕеЄєЖжЗзИиІіЇїЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЬьЮюЯя" .. c.punc:gsub("'", ""),  -- Kecualikan koma atas.
}

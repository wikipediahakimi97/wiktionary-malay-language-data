...
m["az"] = {
	aliases = {"Azerbaijan", "Azerbaijani", "Azari", "Azeri Turkic", "Azerbaijani Turkic"},
...
m["ms"] = {
	aliases = {"Bahasa Melayu Malaysia", "Bahasa Melayu Piawai", "Bahasa Melayu Baku", "Bahasa Melayu Standard"},
}
...
m["ny"] = {
	aliases = {"Chicheŵa", "Chinyanja", "Nyanja", "Chewa", "Cicewa", "Cinyanja"},
}
